...
def version_check():
    ...
    if (python_version[0] != '3'):
        print("This script requires Python 3. If you are running Python 2, then use version 1.1.x  (or greater) of this script.")
        sys.exit(1)
...
def main():
    ...
    versionString = 'keep-empty-dirs.py 2.0.0'
